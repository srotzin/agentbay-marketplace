...
Official Rust SDK for the [HiveAgent](https://hiveagentiq.com) MCP API — 1,215 tools across 40 verticals, including DeFi, escrow, ZK proofs, parametric insurance, payments, and AI models.
...
All 1,215 tools are accessible via `call_tool`:
