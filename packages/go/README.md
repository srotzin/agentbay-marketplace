...
Official Go SDK for the [HiveAgent](https://hiveagentiq.com) MCP API — 828 tools across 40 verticals, including DeFi, escrow, ZK proofs, parametric insurance, payments, and AI models.
...
The `CallTool` method gives you access to all 828 tools by name:
