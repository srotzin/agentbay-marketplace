...
Official Go SDK for the [HiveAgent](https://hiveagentiq.com) MCP API — 1,215 tools across 40 verticals, including DeFi, escrow, ZK proofs, parametric insurance, payments, and AI models.
...
The `CallTool` method gives you access to all 1,215 tools by name:
